...
public class ProductClient {
    ...
    private final RestTemplate restTemplate; // Injecting RestTemplate directly


    public List<PurchaseResponce> purchaseProduct(List<PurchaseRequest> requestBody) {
        ...
        // Using RestTemplate's exchange method directly
